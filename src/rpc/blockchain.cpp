    ...
    return RPCHelpMan{
        ...
        "If verbosity is 0, returns a string that is serialized, hex-encoded data for block 'hash'.\n"
                ...
                },
                {
                    ...
                    RPCResult{"for verbosity = 1", RPCResult::Type::OBJ, "", "", GetBlockV1Fields()},
                    ...
                    Cat(
                        ...
                        {
                            {RPCResult::Type::OBJ, "", "",
                                DecodeTxDoc(/*txid_field_doc=*/"The transaction id", /*wallet=*/false, /*txprevout=*/false, /*fee=*/true)},
                        }}}
                    )},
                    ...
                    Cat(
                        ...
                        {
                            {RPCResult::Type::OBJ, "", "",
                                DecodeTxDoc(/*txid_field_doc=*/"The transaction id", /*wallet=*/false, /*txprevout=*/true, /*fee=*/true)}
                        }}}
                    )},
                },
                RPCExamples{
