                ...
                },
                {
                    RPCResult{"if verbosity is not set or set to 0",
                     ...
                     RPCResult{"if verbosity is set to 1",
                         ...
                         DecodeTxDoc(/*txid_field_doc=*/"The transaction id (same as provided)", /*wallet=*/false, /*txprevout=*/false, /*fee=*/true)),
                    },
                    ...
                    Cat(
                        ...
                        DecodeTxDoc(/*txid_field_doc=*/"The transaction id (same as provided)", /*wallet=*/false, /*txprevout=*/true, /*fee=*/true)
                    )},
                },
                RPCExamples{
...
static RPCHelpMan decoderawtransaction()
{
    return RPCHelpMan{"decoderawtransaction",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    DecodeTxDoc(/*txid_field_doc=*/"The transaction id", /*wallet=*/false, /*txprevout=*/false, /*fee=*/false),
                },
                RPCExamples{
