...
api:
  ./build/bin/bitcoin-cli -regtest api
...
save:
  ./build/bin/bitcoin-cli -regtest api | jq > OpenRPC.json

codegen:
  npx --yes @open-rpc/generator generate -c open-rpc-generator-config.json
